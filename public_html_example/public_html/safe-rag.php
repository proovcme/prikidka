<?php
$siteId = 'rag';
$pageTitle = 'Safe-RAG: Безопасная генерация и фильтрация | WeAreFired';
$pageDescription = 'Safe-RAG: архитектура защиты корпоративного ИИ. Фильтрация токсичных промптов, предотвращение утечек данных и контроль доступа к чанкам.';
$pageKeywords = 'Safe-RAG, безопасность ИИ, защита данных RAG, фильтрация промптов, корпоративный ИИ, PII masking';
...
<div class="nav-group">
  ...
  <div class="nav-row">
    <a href="#concept" class="btn btn-outline">01 / Угрозы</a>
    <a href="#layers" class="btn btn-teal">02 / Слои защиты</a>
    <a href="#compliance" class="btn btn-punch">03 / Compliance</a>
...
<section id="layers" class="content-block">
  <span class="section-num">02 / Layers</span>
  ...
  <ul class="step-list">
    <li class="step-item">
      ...
      <div>
        <div class="step-title">Валидация при загрузке</div>
        <div class="step-text">Safe-RAG проверяет каждый документ перед индексацией: формат, метаданные, консистентность с существующими записями. Подозрительные — на карантин.</div>
      </div>
    </li>
    <li class="step-item">
      <div class="step-num">02</div>
      <div>
        <div class="step-title">Защита от инъекций в запросах</div>
        <div class="step-text">Злоумышленник или ошибочный документ не может «вложить» инструкцию в текст, которая изменит поведение модели. Фильтрация на уровне разбора текста.</div>
      </div>
    </li>
    <li class="step-item">
      <div class="step-num">03</div>
      <div>
        <div class="step-title">PII Masking</div>
        <div class="step-text">Автоматическое обнаружение и маскирование персональных данных (ФИО, телефоны, email) до отправки в LLM. Соответствие 152-ФЗ из коробки.</div>
      </div>
    </li>
    <li class="step-item" style="border-color: var(--c-toc); background: var(--bg-secondary);">
      ...
      <div>
        <div class="step-title" style="color: var(--c-toc);">Chunk-Level ACL</div>
        <div class="step-text">Контроль доступа на уровне отдельных фрагментов. Пользователь видит только те чанки, на которые у него есть права. Коммерческая тайна не утечёт в ответ.</div>
      </div>
    </li>
  </ul>
</section>

<section id="compliance" class="content-block">
  <span class="section-num">03 / Compliance</span>
  <h2 class="section-title">Соответствие законодательству РФ</h2>
  <p class="text-main">Загрузка документов с персональными данными в облачный ИИ — прямое нарушение. Safe-RAG работает в локальном контуре и автоматически соблюдает требования регуляторов.</p>
  
  <div class="tools-grid">
    <div class="tool-card">
      <span class="tool-tag">152-ФЗ</span>
      <h3 class="tool-name">Персональные данные</h3>
      <p class="tool-desc">Любая передача ПДн требует согласия. Локальный контур выполняет требование локализации автоматически. Ни один байт не покидает периметр.</p>
    </div>
    <div class="tool-card c-teal">
      <span class="tool-tag">98-ФЗ</span>
      <h3 class="tool-name">Коммерческая тайна</h3>
      <p class="tool-desc">Сметы, договоры, КП — вероятная КТ. Нет грифа — нет защиты. Есть гриф — нельзя в облако. Safe-RAG работает с грифованными документами безопасно.</p>
    </div>
    <div class="tool-card c-punch">
      <span class="tool-tag">КоАП 2025</span>
      <h3 class="tool-name">Штрафы</h3>
      <p class="tool-desc">Факт утечки = штраф до 15 млн руб. При повторной — до 3% выручки. Уголовная ответственность за разглашение КТ — до 5 лет.</p>
    </div>
  </div>
  
  <div class="insight-box warn">
    <h3>Золотое правило</h3>
    <p class="text-main" style="margin: 0;">Отправил бы этот файл незнакомому подрядчику без NDA? Нет — не загружай в облако. Локальный Safe-RAG решает проблему радикально.</p>
  </div>
</section>
...
<section id="faq" class="content-block">
  ...
  <details class="faq-item">
    <summary>Safe-RAG замедляет систему?</summary>
    <div class="faq-body">Да, на 15-25% из-за слоёв фильтрации. Но для корпоративного контура безопасность важнее скорости. PII masking и ACL работают на этапе индексации, не в рантайме запроса.</div>
  </details>
  <details class="faq-item">
    <summary>Можно ли использовать Safe-RAG с облачными LLM?</summary>
    <div class="faq-body">Технически да, но юридически рискованно для РФ. PII masking снижает риски, но не устраняет их полностью. Для 152-ФЗ и 98-ФЗ рекомендуется полностью локальный контур.</div>
  </details>
  <details class="faq-item">
    <summary>Что такое отравление базы знаний?</summary>
    <div class="faq-body">Когда в архив попадает неверный документ или скан с ошибками OCR. RAG индексирует его и начинает уверенно давать неправильные ответы. Safe-RAG валидирует документы до индексации и отправляет подозрительные на карантин.</div>
  </details>
</section>
