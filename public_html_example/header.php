...
$sites = [
    ...
    'waf'  => ['id'=>'waf',  'page_title'=>'ИИ без магии',       'url'=>'https://ai.ovc.me',  'color'=>'var(--c-waf)',  'cmd'=>'cd ai'],
    ...
    'toc'  => ['id'=>'toc',  'page_title'=>'Расчет',          'url'=>'https://toc.ovc.me', 'color'=>'var(--c-toc)',  'cmd'=>'cd toc'],
...
<link rel="stylesheet" href="https://ovc.me/frontend/ui-kit/css/01_tokens.css">
<link rel="stylesheet" href="https://ovc.me/frontend/ui-kit/css/02_base.css">
<link rel="stylesheet" href="https://ovc.me/frontend/ui-kit/css/03_components.css">
...
.site-header__nav   { flex-shrink: 0; gap: 20px; }
  ...
  <div class="site-header__inner">
    ...
    <nav class="site-header__nav" id="site-nav">
      ...
      <a href="<?= htmlspecialchars($sites['waf']['url'], ENT_QUOTES, 'UTF-8') ?>"
        ...
        <span class="site-header__link-label">ИИ без магии</span>
      </a>
      ...
      <a href="<?= htmlspecialchars($sites['toc']['url'], ENT_QUOTES, 'UTF-8') ?>"
        ...
        <span class="site-header__link-label">Расчет</span>
      </a>
    ...
    <div class="site-header__right">
      ...
      <!-- Контакты -->
      <a href="https://ovc.me/#about"
         class="site-header__tg"
         style="margin-right:4px">
        <span class="cmd"><span class="cli-only">@</span>contact</span>
...
<script src="https://ovc.me/frontend/ui-kit/js/04_components.js"></script>
<script src="https://ovc.me/frontend/ui-kit/js/05_interactions.js"></script>
